    ...
    <head>
        ...
        <style>
            ...
            /* 1. Ensure the app-shell background matches the main content background */
            .app-shell {
                display: grid;
                grid-template-columns: var(--sidebar-width) 1fr;
                min-height: 100vh;
                background-color: var(--bg-soft); /* This fills the 'gap' */
            }

            /* 2. Make sure the main content area fills the height */
            .main {
                padding: 0;
                display: flex;
                flex-direction: column;
                min-width: 0; /* Prevents table from pushing the layout wide */
                background-color: var(--bg-soft);
            }

            /* 3. Optional: Fix the container width */
            .container-fluid {
                width: 100%;
            }
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="search" class="form-control border-start-0" id="variantSearch"
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <c:forEach items="${variants}" var="variant" varStatus="status">
                                    <tr data-parent="${variant.product.productName}">
                                        ...
                                        <td><span class="badge badge-soft text-primary"><c:out
                                                value="${variant.product.itemCode}"/></span></td>
                            ...
                            <div class="text-muted-small">
                                <c:choose>
                                    <c:when test="${not empty variants}">
                                        Showing records starting from ID: <strong>${variants[0].variantId}</strong>
                                    </c:when>
                                    <c:otherwise>No variants found.</c:otherwise>
                                </c:choose>
                            </div>
                            <nav>
                                <ul class="pagination mb-0">
                                    <li class="page-item ${empty param.lastId ? 'disabled' : ''}">
                                        <a class="page-link" href="/variants">
                                    ...
                                    <c:if test="${hasNext}">
                                        <li class="page-item">
                                            <a class="page-link" href="/variants?lastId=${nextCursor}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form class="modal-content needs-validation" novalidate method="post" action="/variants/add">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3"><label class="form-label">Colour</label><input type="text"
                                                                                                  class="form-control"
                                                                                                  name="colour" required>
                        </div>
                        <div class="col-md-6 mb-3"><label class="form-label">Size</label><input type="text"
                                                                                                class="form-control"
                                                                                                name="size" required></div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control price-input selling-price"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3"><label class="form-label">Colour</label><input type="text"
                                                                                                  class="form-control"
                                                                                                  name="colour"
                                                                                                  id="editVariantColour">
                        </div>
                        <div class="col-md-6 mb-3"><label class="form-label">Size</label><input type="text"
                                                                                                class="form-control"
                                                                                                name="size"
                                                                                                id="editVariantSize"></div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">MRP</label>
                            <input type="number" step="0.01" min="0" class="form-control price-input" name="mrp"
                                   id="editVariantMrp" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Selling Price</label>
                            <input type="number" step="0.01" min="0" class="form-control price-input selling-price"
                                   name="sellingPrice" id="editVariantSellingPrice" required>
                            <div class="invalid-feedback">Selling price cannot exceed MRP.</div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="confirmDeleteVariantModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <form class="modal-content" method="post" action="/variants/delete">
                <div class="modal-header"><h5 class="modal-title">Delete Variant?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body"><input type="hidden" name="id" id="deleteVariantId">
                    <p>This action cannot be undone. Are you sure?</p></div>
                <div class="modal-footer">
