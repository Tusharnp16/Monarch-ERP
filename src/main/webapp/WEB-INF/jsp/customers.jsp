                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 text-end">
                            <div class="text-muted-small">Total Customers: <span
                                    class="fw-bold text-dark">${customers.size()}</span></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-3">
                                        <button class="btn btn-sm btn-outline-info"
                                                ...
                                                data-mobile="${c.mobile}" data-gst="${c.gstIn}">
...
<div class="modal fade" id="addCustomerModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content needs-validation" novalidate method="post" action="/customer/add">
...
<div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" method="post" action="/customer/delete">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmDeleteLabel">Delete customer</h5>
...
<div class="modal fade" id="editCustomerModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" method="post" action="/customer/update">
            <div class="modal-header">
