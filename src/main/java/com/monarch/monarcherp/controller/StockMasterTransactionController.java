...
public class StockMasterTransactionController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<StockTransaction>>> getAllStockTransaction() {
        List<StockTransaction> stockTransaction = stockMasterTransactionService.getAllStockTransactions();
